"""Upload the coordinated 1990s elevator textures through Roblox Studio MCP."""
...
SOURCE = ROOT / "assets" / "textures" / "elevator"
FILES = {
    "wall": "elevator_wall_90s_v2.png",
    "ceiling": "elevator_ceiling_90s_v2.png",
    "floor": "elevator_floor_90s_v2.png",
    "door": "elevator_door_90s_v2.png",
}
...
def main() -> int:
    ...
    if missing:
        raise FileNotFoundError(f"Missing elevator textures: {missing}")
    ...
    (SOURCE / "published-elevator-90s-v2.json").write_text(
