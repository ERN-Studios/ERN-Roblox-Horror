...
| `04-level2-vaulted-corridor-seed1182081016.png` | Level 2 vaulted corridor 1 with the arch-rib meshes | `Level2Seed = 1182081016`. `Performance.ArchMeshRibs = true` (on by default since a443bed), so these are the uploaded mesh ribs players get. |
