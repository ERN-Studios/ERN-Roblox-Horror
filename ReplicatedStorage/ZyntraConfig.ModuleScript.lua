...
return {
	...
	Items = {
		SpeedPotion = {
			...
			Description = "Costs 3 Research Tokens. Drink it during a run to move 10% faster for 6 seconds. One per round, it does not stack, and it changes nothing about your stamina.",
		},
		RouteMarker = {
